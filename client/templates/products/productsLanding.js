...
Template.nextProductsLanding.onCreated(function () {
  ...
  this.autorun(() => {
    const slug = "featured";//Reaction.Router.getParam("slug");
...
Template.nextProductsLanding.events({
